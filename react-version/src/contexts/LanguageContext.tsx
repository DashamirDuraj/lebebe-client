...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'Discover our collection of soft, comfortable, and adorable baby clothes made with love',
    'hero.cta': 'Shop Now',
  ...
  sq: {
    ...
    'hero.subtitle': 'Zbuloni koleksionin tonë të rrobave të buta, komode dhe të dashura për foshnja të bëra me dashuri',
    'hero.cta': 'Blej Tani',
    ...
    'newsletter.subtitle': 'Regjistrohu për të marrë ofertat speciale dhe këshilla për kujdesin e foshnjave',
