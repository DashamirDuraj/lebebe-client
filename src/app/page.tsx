  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <section className="relative overflow-hidden bg-[#E6F4FB]">
        ...
        <div className="absolute top-20 right-20 text-4xl animate-float opacity-20">
          🎈
        </div>
        <div className="absolute bottom-32 left-16 text-3xl animate-bounce-soft opacity-20">
          ⭐
        </div>
        <div className="absolute top-40 left-1/4 text-2xl animate-wiggle opacity-20">
          💕
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Premium organic baby clothing crafted with love in Albania. Gentle
              fabrics, curated designs, fast delivery across EU.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-neutral-600 mb-4">
                Premium organic baby clothing crafted with love. Gentle fabrics
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="text-sm text-neutral-600 hover:text-[#7CC4E8] transition-colors"
                  >
                    About Us
                  </a>
                </li>
          ...
          <div className="pt-8 border-t border-neutral-200">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-neutral-600">
              ...
              <div className="flex gap-6">
                <a href="#" className="hover:text-[#7CC4E8] transition-colors">
                  Terms
                </a>
                <a href="#" className="hover:text-[#7CC4E8] transition-colors">
                  Privacy
