        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1
                  className="text-xl md:text-2xl text-[#7CC4E8]"
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              >
                ...
                <span
                  ...
                  } h-0.5 bg-[#7CC4E8] rounded-full group-hover:w-full transition-all`}
                />
              </button>
              <button
              ...
              >
                ...
                <span
                  className={`absolute -bottom-1 left-0 ${
                    activeFilter === "girl" ? "w-full" : "w-0"
                  } h-0.5 bg-[#F7B6C7] rounded-full group-hover:w-full transition-all`}
                />
              </button>
              <button
              ...
              >
                ...
                <span
                  className={`absolute -bottom-1 left-0 ${
                    activeFilter === "newborn" ? "w-full" : "w-0"
                  } h-0.5 bg-[#B8E9D2] rounded-full group-hover:w-full transition-all`}
                />
              </button>
              <a
                href="#"
                className="text-sm font-semibold text-[#DF6B87] relative group"
              >
                {t("header.sale")}
                <Badge className="absolute -top-2 -right-10 bg-[#DC2626] text-white text-xs px-2 py-0 rounded-lg">
                  -30%
                </Badge>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="hidden lg:flex rounded-xl hover:bg-[#E6F4FB]"
              >
