...
export function CartSidebar({
  ...
  const allFieldsFilled =
    formData.name && formData.surname && formData.address && formData.city && formData.phone;
  ...
  }, [allFieldsFilled, formData.phone, showVerificationField]);
        ...
        <SheetHeader>
          <SheetTitle className="flex items-center gap-2">
            {showCheckoutForm && !orderCompleted && (
              <button onClick={handleBackToCart} className="hover:opacity-70 transition-opacity">
          ...
          {orderCompleted ? (
            ...
            <div className="flex-1 overflow-y-auto px-6 space-y-4">
              ...
              {showVerificationField && (
                <div className="bg-[#E6F4FB] p-4 rounded-xl space-y-3 animate-fadeInUp">
              ...
              <div className="pt-4 space-y-3 sticky bottom-0 bg-white pb-4 -mx-6 px-6 border-t">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between font-semibold">
                    <span>Total</span>
                    <span className="text-[#7CC4E8]">€{total.toFixed(2)}</span>
                  </div>
                </div>

                {!showVerificationField ? (
                  <p className="text-xs text-neutral-500 text-center">
                    Complete all fields to receive verification code
                  </p>
                ) : (
                  <Button
                    onClick={handleSubmitOrder}
                    disabled={!formData.verificationCode || isSubmitting}
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-rose-500">€{item.product.price.toFixed(2)}</p>
